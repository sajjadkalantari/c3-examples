      ...
      <div className="max-w-7xl mx-auto px-4 py-5 pt-16">
        ...
        <main className="py-5">
          <div className="bg-white rounded-lg shadow-md p-6">
            <StoredApiKey onChange={handleApiKeyChange} />
            <div className="text-center mb-8 pb-5 border-b border-gray-200">
              <h1 className="text-3xl font-bold text-gray-800 mb-2">Text to Video Generator</h1>
              <p className="text-gray-600 text-lg">Generate videos from text prompts using ComfyUI</p>
            </div>
            <TextToVideoGenerator apiKey={apiKey} />
          </div>
        </main>
      </div>
    </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-5 pt-16">
        ...
        <main className="py-5">
          <div className="bg-white rounded-lg shadow-md p-6">
            <StoredApiKey onChange={handleApiKeyChange} />
            <div className="text-center mb-8 pb-5 border-b border-gray-200">
              <h1 className="text-3xl font-bold text-gray-800 mb-2">Image to Video Generator</h1>
              <p className="text-gray-600 text-lg">Transform your static images into dynamic videos</p>
            </div>
            <ImageToVideoGenerator apiKey={apiKey} />
          </div>
        </main>
      </div>
    </div>
